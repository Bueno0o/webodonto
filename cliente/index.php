    ...
    <ul class="nav justify-content-end">
        ...
        <?php
            echo '<div class="benvindo">
                    <h1>Seja bem-vindo cliente: '.$_SESSION["nome"].'</h1><br />
                </div>';
        ?>
        <div class="botoes">
            <div class="form_pedido">
                <button type="btn" class="btn btn-outline-primary" name="form_pedido" id="pedido">Realize seu pedido</button>
            </div><br />
            <div class="list_pedido">
                <button type="btn" class="btn btn-outline-primary" name="list_pedido" id="list_pedido">Veja seus pedidos</button>
            </div><br />
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#pedido").click(function(){
                    document.location.href = 'form_pedido.php';
                    $(location).attr('href', 'form_pedido.php');
                });
